...
<head>
    ...
    text-align: center;
        ...
        @media (max-width: 900px) {
            ...
            .input-field, .form-group, .login-btn { max-width: 90vw; width: 100%; margin-left: 0; }
        }
        @media (max-width: 600px) {
            ...
            .input-field, .form-group, .login-btn { max-width: 98vw; width: 100%; font-size: 0.95rem; margin-left: 0; }
        }
    </style>
</head>
<body>
