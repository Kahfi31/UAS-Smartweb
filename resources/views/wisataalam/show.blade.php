...
<body>
    ...
    <section class="hero">
        <div class="hero-text">
            <h1>Temukan<br>Damainya<br>Alam di Setiap<br>Langkah!</h1>
            <p>Jelajahi Keindahan Alam Indonesia</p>
    ...
    <section class="card-grid">
        <a href="{{ route('wisataalam.showdetailbromo') }}">
        <div class="card">
            <img src="{{ asset('images/bromo.png') }}" alt="Bromo">
            <div class="card-body">
                <h3>Gunung Bromo</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Probolinggo, Jawa Timur</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">24 Jam</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetailkawahijen') }}">
        <div class="card">
            <img src="{{ asset('images/kawahijen.png') }}" alt="Kawah Ijen">
            <div class="card-body">
                <h3>Kawah Ijen</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Papua Barat</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">06.00 - 18.00 WIT</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetailrajaampat') }}">
        <div class="card">
            <img src="{{ asset('images/rajaampat.png') }}" alt="Raja Ampat">
            <div class="card-body">
                <h3>Raja Ampat</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Sumatera Utara</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">07.00 - 19.00 WIB</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetailtangkubanperahu') }}">
        <div class="card">
            <img src="{{ asset('images/tangkubanperahu.png') }}" alt="Tangkuban Perahu">
            <div class="card-body">
                <h3>Tangkuban Perahu</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Banyuwangi, Jawa Timur</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">02.00 - 12.00 WIB</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetailtumpaksewu') }}">
        <div class="card">
            <img src="{{ asset('images/airterjuntumpaksewu.png') }}" alt="Air Terjun Tumpak Sewu">
            <div class="card-body">
                ...
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">05.00 - 19.00 WIB</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetailpulaukomodo') }}">
        <div class="card">
            <img src="{{ asset('images/pulaukomodo.png') }}" alt="Pulau Komodo">
            <div class="card-body">
                <h3>Pulau Komodo</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Situbondo, Jawa Timur</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">07.00 - 16.00 WIB</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetaildanaukelimutu') }}">
        <div class="card">
            <img src="{{ asset('images/danaukelimutu.png') }}" alt="Danau Kelimutu">
            <div class="card-body">
                <h3>Danau Kelimutu</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Manggarai Barat, NTT</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">08.00 - 18.00 WITA</span>
                </div>
            </div>
        </div>
        </a>
        <a href="{{ route('wisataalam.showdetaildanautoba') }}">
        <div class="card">
            <img src="{{ asset('images/danautoba.png') }}" alt="Danau Toba">
            <div class="card-body">
                <h3>Danau Toba</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Bandung Barat, Jawa Barat</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
