...
<body>
    ...
    <!-- Navbar - Updated to match home.blade.php -->
    <nav class="navbar">
...
<section class="hero-section">
  <img src="{{ asset('images/bromo.png') }}" class="hero-image" alt="Gunung Bromo">
  <h2 class="hero-title">Gunung Bromo</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keindahan alam Gunung Bromo yang memukau dengan lautan pasir, pemandangan matahari terbit yang menakjubkan, dan udara pegunungan yang sejuk. <br>
      Temukan pengalaman petualangan tak terlupakan di salah satu destinasi alam terbaik di Indonesia.
    </p>
