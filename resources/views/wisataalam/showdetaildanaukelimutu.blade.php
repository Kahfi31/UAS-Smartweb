...
<section class="hero-section">
  <img src="{{ asset('images/danaukelimutu.png') }}" class="hero-image" alt="Danau Kelimutu">
  <h2 class="hero-title">Danau Kelimutu</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keindahan Danau Kelimutu yang memukau dengan tiga warna air yang berbeda dan pemandangan matahari terbit yang menakjubkan. <br>
      Temukan pengalaman petualangan tak terlupakan di salah satu destinasi alam terbaik di Nusa Tenggara Timur.
    </p>

    <!-- KULINER CARDS -->
    <div class="alam-grid">
      <div class="alam-card"><img src="{{ asset('images/danaukelimutu.png') }}"><p>Danau Kelimutu</p></div>
      <div class="alam-card"><img src="{{ asset('images/danaukelimutu.png') }}"><p>Danau Kelimutu</p></div>
      <div class="alam-card"><img src="{{ asset('images/danaukelimutu.png') }}"><p>Danau Kelimutu</p></div>
      <div class="alam-card"><img src="{{ asset('images/danaukelimutu.png') }}"><p>Danau Kelimutu</p></div>
    </div>
