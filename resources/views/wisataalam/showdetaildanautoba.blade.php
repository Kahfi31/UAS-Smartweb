...
<section class="hero-section">
  <img src="{{ asset('images/danautoba.png') }}" class="hero-image" alt="Danau Toba">
  <h2 class="hero-title">Danau Toba</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keindahan Danau Toba yang memukau dengan danau vulkanik terbesar di dunia dan pemandangan alam yang menakjubkan. <br>
      Temukan pengalaman petualangan tak terlupakan di salah satu destinasi alam terbaik di Sumatera Utara.
    </p>
