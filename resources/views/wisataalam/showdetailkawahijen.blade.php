...
<section class="hero-section">
  <img src="{{ asset('images/kawahijen.png') }}" class="hero-image" alt="Kawah Ijen">
  <h2 class="hero-title">Kawah Ijen</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keindahan Kawah Ijen yang memukau dengan api biru yang menakjubkan dan pemandangan matahari terbit yang spektakuler. <br>
      Temukan pengalaman petualangan tak terlupakan di salah satu destinasi alam terbaik di Jawa Timur.
    </p>
