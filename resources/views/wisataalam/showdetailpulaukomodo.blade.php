...
<section class="hero-section">
  <img src="{{ asset('images/pulaukomodo.png') }}" class="hero-image" alt="Pulau Komodo">
  <h2 class="hero-title">Pulau Komodo</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keindahan Pulau Komodo yang memukau dengan satwa purba komodo dan pemandangan alam yang menakjubkan. <br>
      Temukan pengalaman petualangan tak terlupakan di salah satu destinasi alam terbaik di Nusa Tenggara Timur.
    </p>
