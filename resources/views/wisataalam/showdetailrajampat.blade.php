...
<section class="hero-section">
  <img src="{{ asset('images/rajaampat.png') }}" class="hero-image" alt="Raja Ampat">
  <h2 class="hero-title">Raja Ampat</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Jelajahi keindahan Raja Ampat yang terkenal dengan gugusan pulau-pulau eksotis, air laut jernih, dan keanekaragaman hayati bawah laut yang luar biasa. <br>
      Temukan pengalaman petualangan tak terlupakan di surga tropis Papua Barat ini.
    </p>
