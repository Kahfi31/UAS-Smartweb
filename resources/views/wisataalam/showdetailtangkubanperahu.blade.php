...
<section class="hero-section">
  <img src="{{ asset('images/tangkubanperahu.png') }}" class="hero-image" alt="Tangkuban Perahu">
  <h2 class="hero-title">Tangkuban Perahu</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati pesona Gunung Tangkuban Perahu dengan kawahnya yang unik, udara sejuk pegunungan, dan pemandangan alam yang memukau. <br>
      Temukan pengalaman wisata alam yang seru di salah satu destinasi favorit di Jawa Barat.
    </p>
