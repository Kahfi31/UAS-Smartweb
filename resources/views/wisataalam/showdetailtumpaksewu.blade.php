...
<section class="hero-section">
  <img src="{{ asset('images/airterjuntumpaksewu.png') }}" class="hero-image" alt="Air Terjun Tumpak Sewu">
  <h2 class="hero-title">Air Terjun Tumpak Sewu</h2>
</section>

  <!-- CONTENT -->
  <main class="content">
    <h1>PANDUAN WISATA <br> ALAM</h1>
    <p class="intro">
      Rasakan keindahan Air Terjun Tumpak Sewu yang megah dengan panorama air terjun bertingkat dan suasana alam yang asri. <br>
      Temukan pengalaman petualangan seru di salah satu air terjun terindah di Indonesia, terletak di perbatasan Lumajang dan Malang, Jawa Timur.
    </p>

    <!-- KULINER CARDS -->
    <div class="alam-grid">
      <div class="alam-card"><img src="{{ asset('images/pecel.png') }}"><p>Pecel Sayur</p></div>
      <div class="alam-card"><img src="{{ asset('images/Sate.png') }}"><p>Sate Kere</p></div>
      <div class="alam-card"><img src="{{ asset('images/Gudeg.png') }}"><p>Gudeg</p></div>
      <div class="alam-card"><img src="{{ asset('images/Jenang.png') }}"><p>Jenang Sumsum</p></div>
    </div>
