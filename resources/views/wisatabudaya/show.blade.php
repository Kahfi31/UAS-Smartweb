...
<body>
    ...
    <section class="hero">
        <div class="hero-text">
            <h1>Menyelami<br>Cerita Lewat<br>Budaya</h1>
            <p>Temukan nilai-nilai lokal lewat seni, tradisi, dan <br>kearifan yang masih hidup di berbagai sudut nusantara</p>
    ...
    <section class="card-grid">
        <a href="{{ route('wisatabudaya.showdetailborobudur') }}">
        <div class="card">
            <img src="{{ asset('images/candiborobudur.png') }}" alt="Candi Borobudur">
            <div class="card-body">
                <h3>Candi Borobudur</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Magelang, Jawa Tengah</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">06.00 - 17.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisatabudaya.showdetailprambanan') }}">
        <div class="card">
            <img src="{{ asset('images/candiprambanan.png') }}" alt="Candi Prambanan">
            <div class="card-body">
    ...
    <a href="{{ route('wisatabudaya.showdetailkeraton') }}">
        <div class="card">
            <img src="{{ asset('images/keratonyogyakarta.png') }}" alt="Keraton Yogyakarta">
            <div class="card-body">
                ...
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">08.00 - 14.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisatabudaya.showdetailcetho') }}">
        <div class="card">
            <img src="{{ asset('images/candicetho.png') }}" alt="Candi Cetho">
            <div class="card-body">
                <h3>Candi Cetho</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Jakarta Barat</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">09.00 - 15.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisatabudaya.showdetailmajapahit') }}">
        <div class="card">
            <img src="{{ asset('images/museummajapahit.png') }}" alt="Museum Majapahit">
            <div class="card-body">
                <h3>Museum Majapahit</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
    ...
    <a href="{{ route('wisatabudaya.showdetailrotterdam') }}">
        <div class="card">
            <img src="{{ asset('images/bentengrotterdam.png') }}" alt="Benteng Rotterdam">
            <div class="card-body">
    ...
    <a href="{{ route('wisatabudaya.showdetailvredeburg') }}">
        <div class="card">
            <img src="{{ asset('images/bentengvredeburg.png') }}" alt="Benteng Vredeburg">
            <div class="card-body">
                <h3>Banteng Vredeburg</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Magelang, Jawa Tengah</span>
                </div>
    ...
    <a href="{{ route('wisatabudaya.showdetailfatahillah') }}">
        <div class="card">
            <img src="{{ asset('images/museumfatahillah.png') }}" alt="Museum Fatahillah">
            <div class="card-body">
                <h3>Museum Fatahillah</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Pekalongan, Jawa Tengah</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">08.00 - 15.00 WIB</span>
                </div>
            </div>
        </div>
    </section>
