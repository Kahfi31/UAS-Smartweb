...
<section class="hero-section">
  <img src="{{ asset('images/candiborobudur.png') }}" class="hero-image" alt="Candi Borobudur">
  <h2 class="hero-title">Candi Borobudur</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Kagumi keagungan Candi Borobudur, warisan budaya dunia yang penuh nilai sejarah dan arsitektur megah. <br>
      Temukan pengalaman spiritual dan budaya di salah satu destinasi wisata budaya paling ikonik di Indonesia.
    </p>
