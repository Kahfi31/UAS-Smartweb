...
<section class="hero-section">
  <img src="{{ asset('images/candicetho.png') }}" class="hero-image" alt="Candi Cetho">
  <h2 class="hero-title">Candi Cetho</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Jelajahi keunikan Candi Cetho, situs budaya dan spiritual di lereng Gunung Lawu yang penuh dengan nilai sejarah dan panorama alam yang indah. <br>
      Temukan pengalaman budaya dan spiritual yang berbeda di salah satu candi Hindu paling terkenal di Jawa Tengah.
    </p>
