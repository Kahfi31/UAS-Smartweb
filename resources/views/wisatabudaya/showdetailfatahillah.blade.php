...
<section class="hero-section">
  <img src="{{ asset('images/museumfatahillah.png') }}" class="hero-image" alt="Museum Fatahillah">
  <h2 class="hero-title">Museum Fatahillah</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Temukan sejarah Jakarta di Museum Fatahillah, bangunan bersejarah di kawasan Kota Tua yang menyimpan banyak koleksi dan kisah masa lalu. <br>
      Rasakan atmosfer budaya dan sejarah di salah satu destinasi wisata budaya paling terkenal di ibu kota.
    </p>

    <!-- KULINER CARDS -->
    <div class="kuliner-grid">
      <div class="kuliner-card"><img src="{{ asset('images/pecel.png') }}"><p>Pecel Sayur</p></div>
      <div class="kuliner-card"><img src="{{ asset('images/Sate.png') }}"><p>Sate Kere</p></div>
      <div class="kuliner-card"><img src="{{ asset('images/Gudeg.png') }}"><p>Gudeg</p></div>
      <div class="kuliner-card"><img src="{{ asset('images/Jenang.png') }}"><p>Jenang Sumsum</p></div>
    </div>
