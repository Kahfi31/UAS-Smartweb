...
<section class="hero-section">
  <img src="{{ asset('images/keratonyogyakarta.png') }}" class="hero-image" alt="Keraton Yogyakarta">
  <h2 class="hero-title">Keraton Yogyakarta</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Rasakan kemegahan dan tradisi Keraton Yogyakarta, pusat kebudayaan Jawa yang sarat sejarah dan nilai luhur. <br>
      Temukan pengalaman budaya yang otentik di jantung kota Yogyakarta.
    </p>
