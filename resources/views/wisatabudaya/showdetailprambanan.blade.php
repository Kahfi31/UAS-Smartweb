...
<section class="hero-section">
  <img src="{{ asset('images/candiprambanan.png') }}" class="hero-image" alt="Candi Prambanan">
  <h2 class="hero-title">Candi Prambanan</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Kagumi kemegahan Candi Prambanan, kompleks candi Hindu terbesar di Indonesia yang kaya akan relief dan kisah Ramayana. <br>
      Temukan pengalaman budaya dan sejarah di salah satu situs warisan dunia UNESCO yang menakjubkan.
    </p>
