...
<section class="hero-section">
  <img src="{{ asset('images/bentengrotterdam.png') }}" class="hero-image" alt="Benteng Rotterdam">
  <h2 class="hero-title">Benteng Rotterdam</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Jelajahi sejarah kolonial di Benteng Rotterdam, benteng peninggalan Belanda yang menjadi ikon Kota Makassar. <br>
      Temukan kekayaan budaya dan arsitektur bersejarah di salah satu destinasi wisata budaya paling menarik di Sulawesi Selatan.
    </p>
