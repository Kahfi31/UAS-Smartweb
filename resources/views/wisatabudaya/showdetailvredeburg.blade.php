...
<section class="hero-section">
  <img src="{{ asset('images/bentengvredeburg.png') }}" class="hero-image" alt="Benteng Vredeburg">
  <h2 class="hero-title">Benteng Vredeburg</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Telusuri sejarah perjuangan bangsa di Benteng Vredeburg, benteng bersejarah di pusat Kota Yogyakarta yang kini menjadi museum nasional. <br>
      Rasakan atmosfer budaya dan sejarah di salah satu destinasi wisata budaya paling penting di Yogyakarta.
    </p>

    <!-- KULINER CARDS -->
    <div class="budaya-grid">
      <div class="budaya-card"><img src="{{ asset('images/bentengvredeburg.png') }}"><p>Benteng Vredeburg</p></div>
      <div class="budaya-card"><img src="{{ asset('images/bentengvredeburg.png') }}"><p>Benteng Vredeburg</p></div>
      <div class="budaya-card"><img src="{{ asset('images/bentengvredeburg.png') }}"><p>Benteng Vredeburg</p></div>
      <div class="budaya-card"><img src="{{ asset('images/bentengvredeburg.png') }}"><p>Benteng Vredeburg</p></div>
    </div>
