...
<section class="hero-section">
  <img src="{{ asset('images/dufan.png') }}" class="hero-image" alt="Dufan">
  <h2 class="hero-title">Dunia Fantasi (Dufan)</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati serunya berpetualang di Dunia Fantasi (Dufan), taman hiburan terbesar di Jakarta dengan berbagai wahana menarik untuk seluruh anggota keluarga. <br>
      Temukan pengalaman liburan yang penuh keceriaan dan tak terlupakan di destinasi favorit keluarga Indonesia.
    </p>
