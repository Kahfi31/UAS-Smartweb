...
<section class="hero-section">
  <img src="{{ asset('images/pantaisanur.png') }}" class="hero-image" alt="Pantai Sanur">
  <h2 class="hero-title">Pantai Sanur</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keindahan Pantai Sanur di Bali, destinasi keluarga yang terkenal dengan pasir putih, ombak tenang, dan pemandangan matahari terbit yang memukau. <br>
      Temukan pengalaman liburan santai dan menyenangkan bersama keluarga di tepi pantai yang ramah anak.
    </p>
