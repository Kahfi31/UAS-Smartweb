...
<head>
    <meta charset="UTF-8">
    <title>Visit Ease - Wisata Keluarga</title>
...
<section class="hero-section">
  <img src="{{ asset('images/tamanmini.png') }}" class="hero-image" alt="Taman Mini Indonesia Indah">
  <h2 class="hero-title">Taman Mini Indonesia Indah</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Jelajahi kekayaan budaya Indonesia di Taman Mini Indonesia Indah, destinasi keluarga yang menghadirkan miniatur rumah adat, museum, taman, dan wahana edukatif. <br>
      Temukan pengalaman liburan seru dan penuh pengetahuan untuk seluruh anggota keluarga di Jakarta.
    </p>
