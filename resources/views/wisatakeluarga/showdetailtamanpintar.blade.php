...
<section class="hero-section">
  <img src="{{ asset('images/tamanpintar.png') }}" class="hero-image" alt="Taman Pintar">
  <h2 class="hero-title">Taman Pintar</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Ajak keluarga belajar sambil bermain di Taman Pintar Yogyakarta, pusat wisata edukasi interaktif dengan berbagai wahana sains dan teknologi. <br>
      Temukan pengalaman liburan yang seru, kreatif, dan penuh pengetahuan untuk anak-anak dan seluruh keluarga.
    </p>
