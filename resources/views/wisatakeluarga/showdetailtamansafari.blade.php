...
<section class="hero-section">
  <img src="{{ asset('images/tamansafari.png') }}" class="hero-image" alt="Taman Safari">
  <h2 class="hero-title">Taman Safari</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Rasakan petualangan seru bersama keluarga di Taman Safari, tempat wisata edukasi satwa dengan berbagai atraksi dan pengalaman interaktif. <br>
      Temukan keanekaragaman hewan dari seluruh dunia dan nikmati liburan yang menyenangkan di alam terbuka.
    </p>
