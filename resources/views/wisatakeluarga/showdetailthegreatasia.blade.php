...
<section class="hero-section">
  <img src="{{ asset('images/thegreat.png') }}" class="hero-image" alt="The Great Asia Africa">
  <h2 class="hero-title">The Great Asia Africa</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Jelajahi keunikan budaya dari berbagai negara di The Great Asia Africa, destinasi wisata keluarga di Lembang yang menghadirkan miniatur landmark, kuliner, dan atraksi budaya dunia. <br>
      Temukan pengalaman liburan seru, edukatif, dan penuh warna bersama keluarga.
    </p>
