...
<section class="hero-section">
  <img src="{{ asset('images/transstudio.png') }}" class="hero-image" alt="Trans Studio">
  <h2 class="hero-title">Trans Studio</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Rasakan serunya berpetualang di Trans Studio, taman hiburan indoor terbesar di Indonesia dengan berbagai wahana, pertunjukan, dan atraksi menarik untuk seluruh keluarga. <br>
      Temukan pengalaman liburan yang penuh keceriaan dan petualangan seru di destinasi favorit keluarga di Bandung dan Makassar.
    </p>
