...
<section class="hero-section">
  <img src="{{ asset('images/pasaer.png') }}" class="hero-image" alt="Pasar Beringharjo">
  <h2 class="hero-title">Pasar Beringharjo</h2>
</section>

  <!-- CONTENT -->
  <main class="content">
    <h1>PANDUAN WISATA <br> KULINER</h1>
    <p class="intro">
      Jelajahi cita rasa otentik Yogyakarta lewat aneka <br> kuliner tradisional yang bisa kamu temui di Pasar
      <br>Beringharjo. Dari pecel sayur hingga jenang, <br>temukan rasa khas yang sulit dilupakan.
    </p>
