...
<body>
    ...
    <section class="hero">
        <div class="hero-text">
            <h1>Mulai<br>Perjalananmu<br>Lewat Karya!</h1>
            <p>Setiap destinasi punya seni, dan seni<br>didapat dari kreativitas</p>
    ...
    <section class="card-grid">
        <a href="{{ route('wisataurban.showdetailkotatua') }}">
        <div class="card">
            <img src="{{ asset('images/kotatua.png') }}" alt="Kota Tua Jakarta">
            <div class="card-body">
                ...
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">08.00 - 21.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisataurban.showdetailbraga') }}">
        <div class="card">
            <img src="{{ asset('images/braga.png') }}" alt="Braga Street">
            <div class="card-body">
                <h3>Braga Street</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
    ...
    <a href="{{ route('wisataurban.showdetailmalioboro') }}">
        <div class="card">
            <img src="{{ asset('images/malioboro.png') }}" alt="Jalan Malioboro">
            <div class="card-body">
    ...
    <a href="{{ route('wisataurban.showdetailalunkotabatu') }}">
        <div class="card">
            <img src="{{ asset('images/batu.png') }}" alt="Alun-Alun Kota Batu">
            <div class="card-body">
                <h3>Alun-Alun Kota Batu</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Surabaya, Jawa Timur</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">07.00 - 22.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisataurban.showdetailchinatown') }}">
        <div class="card">
            <img src="{{ asset('images/chinatown.png') }}" alt="Chinatown Jakarta">
            <div class="card-body">
                <h3>Chinatown Jakarta</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Jakarta Barat</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">08.00 - 22.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisataurban.showdetailseminyak') }}">
        <div class="card">
            <img src="{{ asset('images/seminyak.png') }}" alt="Seminyak, Bali">
            <div class="card-body">
                <h3>Seminyak, Bali</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
    ...
    <a href="{{ route('wisataurban.showdetailSCBD') }}">
        <div class="card">
            <img src="{{ asset('images/SCBD.png') }}" alt="SCBD Jakarta">
            <div class="card-body">
                <h3>SCBD Jakarta</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Jakarta Pusat</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">09.00 - 21.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
    <a href="{{ route('wisataurban.showdetailsurabayanoth') }}">
        <div class="card">
            <img src="{{ asset('images/surabayanorth.png') }}" alt="Surabaya North">
            <div class="card-body">
                <h3>Surabaya North</h3>
                <div class="info-item">
                    <span class="icon">📍</span>
                    <span class="text">Surabaya, Jawa Timur</span>
                </div>
                <div class="info-item">
                    <span class="icon">🕒</span>
                    <span class="text">10.00 - 22.00 WIB</span>
                </div>
            </div>
        </div>
    </a>
