...
<section class="hero-section">
  <img src="{{ asset('images/SCBD.png') }}" class="hero-image" alt="SCBD Jakarta">
  <h2 class="hero-title">SCBD Jakarta</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Temukan gaya hidup modern di kawasan SCBD Jakarta, pusat bisnis, hiburan, dan kuliner dengan gedung pencakar langit dan suasana metropolitan. <br>
      Nikmati pengalaman wisata urban yang mewah, dinamis, dan penuh inspirasi di jantung ibu kota.
    </p>
