...
<section class="hero-section">
  <img src="{{ asset('images/parkbatu.png') }}" class="hero-image" alt="Alun-Alun Kota Batu">
  <h2 class="hero-title">Alun-Alun Kota Batu</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati suasana segar dan meriah di Alun-Alun Kota Batu, ruang publik ikonik dengan wahana bianglala, taman bermain, dan kuliner khas Malang Raya. <br>
      Temukan pengalaman rekreasi keluarga dan wisata malam yang seru di pusat kota Batu.
    </p>
