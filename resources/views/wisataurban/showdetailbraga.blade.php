...
<section class="hero-section">
  <img src="{{ asset('images/braga.png') }}" class="hero-image" alt="Jalan Braga">
  <h2 class="hero-title">Jalan Braga</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Rasakan nuansa klasik dan artistik di Jalan Braga, ikon kota Bandung yang dipenuhi kafe, galeri seni, dan bangunan bersejarah. <br>
      Temukan pengalaman wisata urban yang unik, penuh sejarah, dan cocok untuk bersantai maupun berfoto.
    </p>
