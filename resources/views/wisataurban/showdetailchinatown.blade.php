...
<section class="hero-section">
  <img src="{{ asset('images/chinatown.png') }}" class="hero-image" alt="Chinatown Bandung">
  <h2 class="hero-title">Chinatown Bandung</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Jelajahi warna-warni budaya Tionghoa di Chinatown Bandung, kawasan wisata tematik dengan arsitektur khas, kuliner, dan spot foto menarik. <br>
      Temukan pengalaman wisata urban yang unik, edukatif, dan penuh cita rasa di tengah kota Bandung.
    </p>
