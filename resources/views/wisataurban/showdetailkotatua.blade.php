...
<section class="hero-section">
  <img src="{{ asset('images/kotatua.png') }}" class="hero-image" alt="Kota Tua Jakarta">
  <h2 class="hero-title">Kota Tua Jakarta</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Rasakan atmosfer sejarah di Kota Tua Jakarta, kawasan bersejarah dengan bangunan kolonial, museum, dan spot foto ikonik. <br>
      Temukan pengalaman wisata urban yang edukatif, penuh cerita, dan cocok untuk rekreasi keluarga di jantung ibu kota.
    </p>
