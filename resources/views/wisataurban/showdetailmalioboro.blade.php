...
<section class="hero-section">
  <img src="{{ asset('images/malioboro.png') }}" class="hero-image" alt="Jalan Malioboro">
  <h2 class="hero-title">Jalan Malioboro</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati keramaian dan pesona budaya di Jalan Malioboro, pusat wisata belanja, kuliner, dan seni di Yogyakarta. <br>
      Temukan pengalaman wisata urban yang penuh warna, cocok untuk berburu oleh-oleh, berfoto, dan menikmati suasana khas Jogja.
    </p>
