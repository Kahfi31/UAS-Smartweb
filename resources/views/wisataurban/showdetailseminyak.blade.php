...
<section class="hero-section">
  <img src="{{ asset('images/seminyak.png') }}" class="hero-image" alt="Seminyak Bali">
  <h2 class="hero-title">Seminyak Bali</h2>
</section>
  ...
  <main class="content">
    ...
    <p class="intro">
      Nikmati gaya hidup modern di Seminyak, kawasan wisata urban di Bali yang terkenal dengan pantai indah, beach club, restoran, dan butik trendi. <br>
      Temukan pengalaman liburan yang stylish, santai, dan penuh hiburan di destinasi favorit wisatawan dunia.
    </p>
