...
<head>
    <meta charset="UTF-8">
    <title>Visit Ease - Wisata Urban</title>
...
<section class="hero-section">
  <img src="{{ asset('images/surabayanorth.png') }}" class="hero-image" alt="Surabaya North Quay">
  <h2 class="hero-title">Surabaya North Quay</h2>
</section>

  <!-- CONTENT -->
  <main class="content">
    <h1>PANDUAN WISATA <br> URBAN</h1>
    <p class="intro">
      Nikmati panorama laut dan suasana modern di Surabaya North Quay, destinasi wisata urban di pelabuhan Tanjung Perak dengan view kapal pesiar, kuliner, dan spot foto menarik. <br>
      Temukan pengalaman rekreasi keluarga dan wisata malam yang seru di tepi laut Surabaya.
    </p>

    <!-- KULINER CARDS -->
    <div class="urban-grid">
      <div class="urban-card"><img src="{{ asset('images/pecel.png') }}"><p>Pecel Sayur</p></div>
      <div class="urban-card"><img src="{{ asset('images/Sate.png') }}"><p>Sate Kere</p></div>
      <div class="urban-card"><img src="{{ asset('images/Gudeg.png') }}"><p>Gudeg</p></div>
      <div class="urban-card"><img src="{{ asset('images/Jenang.png') }}"><p>Jenang Sumsum</p></div>
    </div>
